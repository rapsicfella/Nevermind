...
public:
    ...
    {
        return _makeLamdaOutgoing<void>(std::move(response), std::move(ex), std::move(sent), this, &Demo::HelloPrx::_iceI_sayHello, context);
    }
...
public:
    ...
    ::Ice::AsyncResultPtr begin_sayHello(const ::Demo::Callback_Hello_sayHelloPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_sayHello(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_sayHello(const ::Ice::Context& context, const ::Demo::Callback_Hello_sayHelloPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_sayHello(context, cb, cookie);
    }
